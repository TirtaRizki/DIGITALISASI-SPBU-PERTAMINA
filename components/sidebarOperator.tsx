...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: "Checklist Driveaway", path: "/operator/checklist/driveaway", icon: ClipboardCheck },
    { name: "Checklist Awal Shift", path: "/operator/checklist/awal-shift", icon: ClipboardCheck },
    { name: "Laporan Kendala", path: "/operator/laporan-kendala", icon: FileText },
  ];
